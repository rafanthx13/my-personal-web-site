...
- Adicionados ícones para GitHub, LinkedIn e Kaggle.
- Substituído o ícone de e-mail por `@` para melhorar sua visualização.

### Competências

- Adicionada uma escala visual de 1 a 5 estrelas para indicar o nível de domínio de cada tecnologia.
- Destacadas com borda branca e posicionadas primeiro em seus grupos as principais tecnologias: jQuery, PHP, Laravel, Python e SQL.
