...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Dev Tool Box",
    category: "WebPage",
    description: "Caixa de Ferramentas e CheeatSheet úteis pro trabalho",
    image: asset("/images/projects/dev-tool-box.png"),
    imageAlt: "Visualização do projeto Análise da área de dados no Brasil",
    tags: ["WebPage", "HTML", "CSS", "VanillaJS"],
    href: "https://www.kaggle.com/code/rafanthx13/analise-da-rea-de-dados-no-brasil/notebook",
    externalLinkLabel: "Ver site",
    challenge: "Criar ferramentas úteis para o dia de trabalho de um programador.",
    solution: "Foi criado uma página web no github, e hospdado no github page, tendo assism fácil acesso. é feita somente com JS não envolvendo banco",
    results: [
      "Utildiade",
      "Evita ter que pesquisar ferraemntas em todo lugar",
      "Personalizávle a minha necessidade",
    ],
  },
  {
    ...
    challenge: "Ao invés de anotar o que fez e vai fazer no dia, nessa ferramenta permite organizar anotaçoes do trabalho",
    solution: "Foiffeita uma alicçao apra rodar locamente. Possui uma itnerface focada no dai, nas tarefas do dia. Tem área de lembretes, gestao de tempo, de anotaçoes e conquista. ",
    results: [
      "Gerencia de tarefas; Mantem histórico",
      "Pemrite visualziaço md simples e local, pois usa SQLIte",
    ],
  },
];
